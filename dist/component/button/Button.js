...
var Button = (function (_super) {
    ...
    Button.prototype.componentWillMount = function () {
        var _a = this.props, theme = _a.theme, display = _a.display, size = _a.size, type = _a.type, shape = _a.shape, loading = _a.loading;
        var _p = this.props;
        this.theme_classname = classnames("hzp-btn", theme ? "btn-" + theme : "btn-" + domUtil_1._fitlerProps(_p, _theme), display ? "btn-" + display : "btn-" + domUtil_1._fitlerProps(_p, _dispaly), size ? "size-" + size : "size-" + domUtil_1._fitlerProps(_p, _size), type ? "type-" + type : "type-" + domUtil_1._fitlerProps(_p, _type), shape ? "shape-" + shape : "shape-" + domUtil_1._fitlerProps(_p, _shape));
    };
    Button.prototype.render = function () {
        var _a = this.props, icon = _a.icon, loading = _a.loading, iconRight = _a.iconRight;
        console.log(icon);
        return (React.createElement("button", {className: this.theme_classname}, 
            icon ?
                loading ?
